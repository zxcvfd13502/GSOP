...
class LlavaMetaForCausalLM(ABC):
    ...
    def encode_images(self, images):
        ...
        return image_features, index_mask, image_attentions, token_indices
    ...
    def prepare_inputs_labels_for_multimodal(
        ...
        if type(images) is list or images.ndim == 5:
            ...
            image_features, index_masks, image_attns, token_indices = self.encode_images(concat_images)
            ...
            image_features, index_masks, image_attns, token_indices = self.encode_images(images)
